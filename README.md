...
![LOT equation](https://latex.codecogs.com/png.latex?LOT_\sigma%20(\mu)%20=%20\arg\min_{T:%20T_\sharp%20\sigma%20=%20\mu}%20\int_{\mathbb{R}^d}%20\Vert%20T(x)%20-%20x%20\Vert^2%20d\sigma(x))
